...
export  const getFeaturesProduct = ()=>async(dispatch)=>{
    try{
        ...
        dispatch({type:ALL_PRODUCT_FAIL,paylod:error.response.data.message})
    }
}
...
export const productReview = (review)=>async(dispatch)=>{
    try{
    ...
    const config = {
        ...
        dispatch({type:NEW_REVIEW_SUCCESS,payload:data.sucess,config})
