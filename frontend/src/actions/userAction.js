...
export const updateProfile = (userData)=>async(dispatch)=>{
  try{
      ...
      const {data} = await axios.put(`/api/v1/changeProfile`,userData,config)
...
export const updateUserPassword=(passwords)=>async(dispatch)=>{
  try{
    ...
    const {data} = await axios.put(`/api/v1/changePassword`,passwords,config)
...
export const deleteUser=(id)=>async(dispatch)=>{
  try{
    ...
    dispatch({type:DELETE_USER_FAIL,paylaod:error.response.data.message})
  }
}
